...
func _process(delta):
	if target:
		...
		global_rotation.x = lerp_angle(global_rotation.x, $Node3D.global_rotation.x, 50*delta)
		global_rotation.y = lerp_angle(global_rotation.y, $Node3D.global_rotation.y, 50*delta)
		global_rotation.z = lerp_angle(global_rotation.z, $Node3D.global_rotation.z, 50*delta)
